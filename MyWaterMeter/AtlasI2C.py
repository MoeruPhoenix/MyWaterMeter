...
class AtlasI2C:
    ...
    def read(self, num_of_bytes=31):
        ...
        if is_valid:
            ...
            tester = char_list[6] + char_list[7] + char_list[8] + char_list[9]
            #print(tester)
            #tester = "pH level is: " +  str(''.join(tester))\
            tester = str(''.join(tester))
            #result = "Success: " +  str(''.join(char_list))
        else:
            tester = "Error " + self.get_device_info() + ": " + error_code
